...
async function explore() {
  ...
  spinner.success({
    text:
      "You successfully encountered a wild " +
      animalEncountered.name.trim() +
      ".",
  });
  console.log();
  console.log("Description: ");
  console.log(titleGradient.multiline(animalEncountered.description));
  console.log();
  console.log(
    "Scientific Name: " + titleGradient(animalEncountered.type.capitalize())
  );
  console.log();
  console.log(
    "Found in the: " + titleGradient(animalEncountered.biome.capitalize())
  );
  console.log();
  console.log("Color: " + titleGradient(animalEncountered.color.capitalize()));
  console.log();
  console.log(
  ...
  clipboard.writeSync(animalEncountered.ascii);
  console.log();
